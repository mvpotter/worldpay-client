 ...
 * @since 05/08/2017
 */
public class CreditRequest extends WorldPayRequest {
    ...
    public CreditRequest(final double amount, final Card card) {
        this.amount = amount;
        this.card = card;
    }

    public CreditRequest(final double amount, final Card card, final Boolean addToVault) {
        this(amount, card);
